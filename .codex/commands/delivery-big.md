...
Use this repository's current `origin/main` plus `AGENTS.md`, `docs/global-project-adapters.md`, and `.claude/commands/delivery.md` as the local baseline. Do not import Psihotavr-specific baseline rules into Reiki.
