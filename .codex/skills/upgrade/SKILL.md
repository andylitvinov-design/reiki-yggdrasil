...
Use this skill to improve the agent system itself: prompts, command adapters, routing rules, memory schemas, validation gates, installer templates, or tool-use workflows.
