...
// extracts CSS variables used for inner cover
{
...
// extracts CSS variables used for outer cover
{
...
// extracts computed backgroundImage url()
{
...
// does not require real DOM/window (all tests above run in Node without DOM)
console.log("PASS: does not require real DOM/window");
