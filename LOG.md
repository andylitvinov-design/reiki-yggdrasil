...
## 2026-06-01 — Emergency revert PR #179 from main `/profile`

- Branch: `codex/revert-heavy-profile-main-route`.
- Reverted merge commit: `3786fdd244a8ff1547a09252d9fa9ba98cd783c5`.
- Reason: after PR #179, live `https://mentalica.vercel.app/profile` again stayed on `Загружаю кабинет...`; before PR #179, the lite fallback route worked.
- Changed files:
  - `src/main.jsx`
