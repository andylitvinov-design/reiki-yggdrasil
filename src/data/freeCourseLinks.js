...
export const freeCourseLinks = [
  {
    ...
    recommendedPlacement: ["Мистерии", "Греческие мистерии"],
    notes: "Название взято из PR #11; прямой URL курса и прямой video/embed URL требуют проверки."
  },
  {
    id: "FREE-PSI-PLANETS",
    ...
    embedUrl: null,
    urlStatus: "needs verification",
    recommendedPlacement: ["Мистерии", "Сила намерения"],
    notes: "Название взято из PR #11; прямой URL курса и прямой video/embed URL требуют проверки."
  },
  {
    ...
    embedUrl: null,
    urlStatus: "needs verification",
    recommendedPlacement: ["Школа волшебников", "Защита"],
    notes: "Название взято из PR #11; прямой URL курса и прямой video/embed URL требуют проверки."
  },
  {
    ...
    embedUrl: null,
    urlStatus: "needs verification",
    recommendedPlacement: ["Мистерии", "Майя"],
    notes: "Название взято из PR #11; прямой URL курса и прямой video/embed URL требуют проверки."
  },
  {
    ...
    embedUrl: null,
    urlStatus: "needs verification",
    recommendedPlacement: ["Мистерии", "Египетские мистерии"],
    notes: "Название взято из PR #11; прямой URL курса и прямой video/embed URL требуют проверки."
  },
  {
    ...
    embedUrl: null,
    urlStatus: "needs verification",
    recommendedPlacement: ["Мистерии", "Дионис"],
    notes: "Название взято из PR #11; прямой URL курса и прямой video/embed URL требуют проверки."
  }
];
