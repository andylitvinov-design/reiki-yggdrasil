...
export function normalizePowerPlaceComposition(composition) {
  ...
  if (Object.hasOwn(sourceObjectRefs, CENTER_IMAGE_OFFSET_X_REF_KEY)) {
    objectRefs[CENTER_IMAGE_OFFSET_X_REF_KEY] = normalizeNumericRef(sourceObjectRefs[CENTER_IMAGE_OFFSET_X_REF_KEY], 20, 80, 50);
  }
  if (Object.hasOwn(sourceObjectRefs, CENTER_IMAGE_OFFSET_Y_REF_KEY)) {
    objectRefs[CENTER_IMAGE_OFFSET_Y_REF_KEY] = normalizeNumericRef(sourceObjectRefs[CENTER_IMAGE_OFFSET_Y_REF_KEY], 20, 80, 50);
  }
